...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
            ...
            break
            case 'sc': {
                m.reply('Script : 𝗦𝗜𝗟𝗔𝗞𝗔𝗡 𝗖𝗛𝗔𝗧 𝗢𝗪𝗡𝗘𝗥\n\n 𝗝𝗔𝗡𝗚𝗔𝗡 𝗟𝗨𝗣𝗔 𝗕𝗔𝗪𝗔 𝗗𝗔𝗡𝗔 𝗪𝗚𝗪𝗚🗿')
            }
            break
            case 'chat': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    ...
                                    url: '𝐌𝐀𝐔 𝐍𝐆𝐀𝐏𝐀𝐈𝐍 𝐁𝐀𝐌𝐇🗿'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Number Phone Owner',
                                    phoneNumber: '+62 819-3322-5481'
                                }
                            }, {
                                quickReplyButton: {
...
■■■■■ 100%
╔═══❖•ೋ°
╟𓆩☺𓆪 𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐌𝐀𝐑𝐒𝐙𝐗𝐘 𝐁𝐎𝐓 𝐌𝐄𝐍𝐔
╟    𝑺𝒊𝒍𝒂𝒉𝒌𝒂𝒏 𝑫𝒊𝒑𝒊𝒍𝒊𝒉 𝑴𝒆𝒏𝒖𝒏𝒚𝒂
╟📄*𝐌𝐀𝐔 𝐒𝐄𝐖𝐀 𝐁𝐎𝐓? 𝐇𝐔𝐁𝐔𝐍𝐆𝐈 𝐎𝐖𝐍𝐄𝐑*
╟ 𝟏 𝐌𝐈𝐍𝐆𝐆𝐔 3𝐊
╟ 𝐏𝐄𝐑𝐌𝐀𝐍𝐄𝐍 5𝐊
╚═══❖•ೋ°
╔═.✵.════ 𝐆𝐑𝐔𝐏 𝐌𝐄𝐍𝐔 ❊╌──┈⊰᯽⊱
